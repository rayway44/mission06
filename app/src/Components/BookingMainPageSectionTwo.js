        ...
        <div id='booking-main-page-section-two-holder'>
            <div class='booking-main-page-section-two-icon'>
                <div class='booking-main-page-section-two-icon-img'>
                    <img src='images/Empty Bed (Traced).png' />
                </div>
            ...
            <div class='booking-main-page-section-two-icon'>
                <div class='booking-main-page-section-two-icon-img'>
                    <img src='images/Bathtub (Traced).png' />
                </div>
                <div class='booking-main-page-section-two-icon-title'>
                    <br/>2 Bathrooms
                </div>
            ...
            <div class='booking-main-page-section-two-icon'>
                <div class='booking-main-page-section-two-icon-img'>
                    <img src='images/Living Room (Traced).png' />
                </div>
                <div class='booking-main-page-section-two-icon-title'>
                    <br/>2 Living Rooms
                </div>
            ...
            <div class='booking-main-page-section-two-icon'>
                <div class='booking-main-page-section-two-icon-img'>
                    <img src='images/Parking (Traced).png' />
                </div>
                <div class='booking-main-page-section-two-icon-title'>
                    <br/>1 Garage
                </div>
            ...
            <div class='booking-main-page-section-two-icon'>
                <div class='booking-main-page-section-two-icon-img'>
                    <img src='images/Dog Paw (Traced).png' />
                </div>
                <div class='booking-main-page-section-two-icon-title'>
                    <br/>Pet Friendly
                </div>
